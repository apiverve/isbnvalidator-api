...
namespace APIVerve\Isbnvalidator;
...
/**
 * Client for the ISBN Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/isbnvalidator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/isbnvalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\IsbnvalidatorClient] {$message}\n";
        }
    }
}
