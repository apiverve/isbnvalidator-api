...
namespace APIVerve.API.ISBNValidator
{
    ...
    /// <summary>
    /// Client for the ISBNValidator API
    /// </summary>
    public class ISBNValidatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/isbnvalidator";
        ...
        {
            { "isbn", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public ISBNValidatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ISBNValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ISBNValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ISBNValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ISBNValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(ISBNValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ISBNValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ISBNValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ISBNValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ISBNValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ISBNValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ISBNValidatorQueryOptions options)
        {
