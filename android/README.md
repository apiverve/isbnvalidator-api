...
```gradle
dependencies {
    implementation 'com.github.apiverve:isbnvalidator-api:1.1.14'
}
```
...
```java
import com.apiverve.isbnvalidator.ISBNValidatorAPIClient;
import com.apiverve.isbnvalidator.APIResponse;
import com.apiverve.isbnvalidator.APIException;

// Initialize the client
ISBNValidatorAPIClient client = new ISBNValidatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("isbn", "978-0-306-40615-7");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/isbnvalidator](https://docs.apiverve.com/ref/isbnvalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/isbnvalidator](https://docs.apiverve.com/ref/isbnvalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/isbnvalidator-api/issues)
