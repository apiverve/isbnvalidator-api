...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/isbnvalidator',
        'Source': 'https://github.com/apiverve/isbnvalidator-api',
        'Bug Tracker': 'https://github.com/apiverve/isbnvalidator-api/issues'
    },
    classifiers=[
