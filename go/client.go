// Package isbnvalidator provides a Go client for the ISBN Validator API.
//
// For more information, visit: https://apiverve.com/marketplace/isbnvalidator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/isbnvalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the ISBN Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new ISBN Validator API client.
...
// Execute makes a request to the ISBN Validator API with typed parameters.
//
...
//   - isbn (required): string - The ISBN number to validate (ISBN-10 or ISBN-13, with or without separators)
